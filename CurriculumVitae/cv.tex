...
\item[] M.Sc, 
        ...
        \begin{innerlist}
        \item Magna Cum Laude (Thesis grade: 95)
...
\item[] B.Sc.,
        \href{http://www.cs.biu.ac.il/}
             {Computer Science} \hfill \textbf{2007~--2009}
        \begin{innerlist}
        \item Computer Science Extensive Track
        \item Courses average: 88
        \end{innerlist}
\end{outerlist}
...
\section{Courses}
\begin{innerlist}
	\item Java Design Patterns (Sela College) \hfill\textbf{2014}
	\item Extreme Java (Sela College) \hfill\textbf{2014}
	\item Spring 3 - Java Framework (John Bryce) \hfill\textbf{2013}
	\item Programming in HTML5 with JavaScript and CSS3 (Sela College)
	\hfill\textbf{2013}
\end{innerlist}
...
\begin{bibenum}
	\item Matan Keidar and Gal A. Kaminka, Efficient Frontier Detection for Robot
	Exploration. In \emph{International Journal of Robotics Research(IJRR)}, 2013.
...
\item[] \textit{Teaching Assistant}%
    \hfill \textbf{March 2010~-- October 2012}
...
\item[] 
	\begin{innerlist} 
		\item Maven, Gradle, Jenkins, Spring, Git, Subversion 
	\end{innerlist}
%	\halfblankline
\end{outerlist}
\halfblankline
